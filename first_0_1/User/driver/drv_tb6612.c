...
void DRV_TB6612_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(TB1_CLK, ENABLE);
    ...
    /* Historical recovery wiring comments are retained; no direction outputs are configured. */
...
void DRV_TB6612_SetSpeed(uint8_t motor, int16_t speed)
{
    ...
    case MOTOR_RIGHT:
        ...
        break;
        /* Historical channel notes; recovery motor cases have been removed. */
